...
It renames all the occurrences of humanoid_lab (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the humanoid_lab folder
        os.rename(
            os.path.join(root_dir_path, "exts", "humanoid_lab", "humanoid_lab"),
            os.path.join(root_dir_path, "exts", "humanoid_lab", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "humanoid_lab"), os.path.join(root_dir_path, "exts", new_name))
